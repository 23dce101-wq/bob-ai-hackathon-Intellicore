import { ArrowRight, CheckCircle, Loader2, Undo2, Wand2 } from "lucide-react";
  ...
  return (
    <section className="panel p-4">
      <header className="mb-3 flex flex-wrap items-center justify-between gap-2">
        ...
        {applied ? (
          <Button variant="outline" onClick={onRevert} disabled={pending || isApplying}>
            <Undo2 className="size-4" aria-hidden /> Revert to original plan
          </Button>
        ) : (
          <Button onClick={onApply} disabled={pending || isApplying || moves.length === 0}>
            {isApplying ? (
              <>
